 ...
 const [scrolled, setScrolled] = useState(false)
  ...
  useEffect(() => {
   ...
   return (
    ...
    } mobile-padding py-3 sm:py-4 sticky top-0 z-50 animate-fade-in-down shadow-soft`} style={{ position: 'sticky', top: 0, zIndex: 50 }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 animate-slide-right">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 hidden sm:block animate-pulse-slow">Secure note-taking made simple</p>
            </div>
          </div>
          
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-4">
            <Link to="/profile" className="flex items-center space-x-3 glass rounded-xl px-4 py-2 animate-slide-left shadow-soft interactive-lift hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-200 dark:hover:border-red-700 hover:text-red-600 dark:hover:text-red-400 transition-all duration-200 interactive-glow"
              icon={<LogOut />}
            >
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            <Button
              ...
              className="touch-target interactive-glow"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-3 animate-fade-in-up">
            <div className="glass rounded-2xl p-4 space-y-4 shadow-lg interactive-lift">
              ...
              <Link to="/profile" className="block w-full">
                <Button
                  variant="outline"
                  size="md"
                  className="w-full mb-2 interactive-glow"
                  icon={<User />}
                >
                  Profile
                </Button>
              ...
              <div className="flex space-x-2">
                ...
                <div className="flex-1">
                  <Button
                    ...
                    variant="outline"
                    size="md"
                    className="w-full hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-200 dark:hover:border-red-700 hover:text-red-600 dark:hover:text-red-400 interactive-glow"
                    icon={<LogOut />}
                  >
                    Sign Out
                  </Button>
